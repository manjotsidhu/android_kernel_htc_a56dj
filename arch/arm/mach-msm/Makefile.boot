...
ifeq ($(CONFIG_MACH_A16_UL)$(CONFIG_MACH_A16_DWG)$(CONFIG_MACH_E36_UL), y)
    htc_dtb-$(CONFIG_ARCH_MSM8226)  += msm8926-a16ul.dtb
    htc_dtb-$(CONFIG_ARCH_MSM8226)  += msm8926-a16dwg.dtb
    htc_dtb-$(CONFIG_ARCH_MSM8226)  += msm8926-e36ul.dtb
endif
ifeq ($(CONFIG_MACH_A56DJ_UL)$(CONFIG_MACH_A56DJ_UHL)$(CONFIG_MACH_A56DJ_DUGL), y)
    htc_dtb-$(CONFIG_ARCH_MSM8226)  += msm8926-a56djdugl.dtb
endif
