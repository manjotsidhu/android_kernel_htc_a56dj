...
#ifdef CONFIG_HTC_DEBUG_RIL_PCN0014_HTC_RAMDUMP_WHEN_BAM_DMUX_TIMEOUT
...
static int ssrestart_check(void)
{
	...
	{
		panic("ssrestart_check bam_dmux time out\n");
	}
#endif
...
static void reconnect_to_bam(void)
{
	...
	if (!power_management_only_mode){
		queue_rx();
#ifdef CONFIG_HTC_DEBUG_RIL_PCN0006_HTC_DUMP_BAM_DMUX_LOG
	fp_reconnect_to_bam = 12;
#endif
	}

#ifdef CONFIG_HTC_DEBUG_RIL_PCN0006_HTC_DUMP_BAM_DMUX_LOG
	fp_reconnect_to_bam = 13;
#endif
...
#ifdef CONFIG_HTC_DEBUG_RIL_PCN0006_HTC_DUMP_BAM_DMUX_LOG
	fp_disconnect_to_bam = 11;
#endif
	if (disconnect_ack)
		toggle_apps_ack();

#ifdef CONFIG_HTC_DEBUG_RIL_PCN0006_HTC_DUMP_BAM_DMUX_LOG
	fp_disconnect_to_bam = 12;
#endif
	verify_tx_queue_is_empty(__func__);
}
