...
// htc battery ++
static struct gpiomux_setting gpio_batt_act_config = { //While OVP
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
static struct gpiomux_setting gpio_batt_susp_config = {  //init status
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
};
static struct msm_gpiomux_config msm_batt_configs[] __initdata = {
	{
		.gpio = 37,
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_batt_act_config,
			[GPIOMUX_SUSPENDED] = &gpio_batt_susp_config,
		},
	},
...
static struct gpiomux_setting  qua_mi2s_sus_cfg1 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_aud_configs[] __initdata = {
	...
	},
	{
		...
		.settings = {
			[GPIOMUX_SUSPENDED] = &qua_mi2s_sus_cfg1,
			[GPIOMUX_ACTIVE] = &qua_mi2s_act_cfg,
		},
	},
	{
...
//htc audio --
//htc battery ++
	 msm_gpiomux_install(msm_batt_configs,
			ARRAY_SIZE(msm_batt_configs));
//htc battery --
	if (of_board_is_skuf())
