...
struct lm3697_data {
	...
	defined(CONFIG_MACH_A16_UL) || defined(CONFIG_MACH_A16_DWG) || \
	defined(CONFIG_MACH_A56DJ_UL) || defined(CONFIG_MACH_A56DJ_UHL) || defined(CONFIG_MACH_A56DJ_DUGL) || \
