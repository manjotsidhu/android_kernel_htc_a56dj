...
static const struct mmc_fixup mmc_fixups[] = {
	...
	/* Cache is default disabled. Use remove_quirk_mmc to remove
	   MMC_QUIRK_CACHE_DISABLE if needs this feature. */
#if 0
	/*
...
static int mmc_select_hs200(struct mmc_card *card, u8 *ext_csd)
{
	...
	/* workaround for samsung eMMC init failure
	 * After HS200 tuning command, comand may get CRC error.
	 * add a dummy read here can avoid the issue */
