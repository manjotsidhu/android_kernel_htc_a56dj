...
static inline int smb358_get_batt_voltage(int *result)
{
	return -ENXIO;
}
...
static inline int smb358_set_limit_charge_on_high_vol_enable(bool enable)
{
	return -ENXIO;
}
...
static inline int smb358_gauge_get_attr_text(char *buf, int size)
{
	return -ENXIO;
}
...
static inline int smb358_set_chg_iusbmax(int val)
{
	return -ENXIO;
}
static inline int smb358_set_chg_vin_min(int val)
{
	return -ENXIO;
}
static inline int smb358_get_chg_usb_iusbmax(void)
{
	return -ENXIO;
}
static inline int smb358_get_chg_vinmin(void)
{
	return -ENXIO;
}
static inline int smb358_get_input_voltage_regulation(void)
{
	return -ENXIO;
}
#endif /* CONFIG_HTC_BATT_8960 */
